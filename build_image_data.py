...
tf.app.flags.DEFINE_string('train_directory', 'all_photos/',
                           'Training data directory')

tf.app.flags.DEFINE_string('validation_directory', 'all_photos/',
...
tf.app.flags.DEFINE_string('labels_file', 'all_labels.txt', 'Labels file')
